# Thunder - Roblox Script Executor 2026

> **The most reliable Roblox script executor for Windows.** Thunder Executor delivers zero-lag Lua injection, a built-in script hub with 500+ scripts, and an ultra-light desktop interface — updated for 2026.
...
[![Stars](https://img.shields.io/github/stars/Thunder-Execut?style=flat-square)](https://github.com)
...
git clone https://github.com/Thunder-Execut.git
cd Thunder-Execut
...
Thunder v2.4 runs fully offline, uses under 40 MB RAM at idle, and ships with more bundled scripts than most alternatives.
...
<p align="center">
  <i>Precision execution, zero compromise. Thunder v2.4 — built for 2026.</i>
</p>
